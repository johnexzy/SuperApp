<?php
  ...
  $request_url = "http://127.0.0.1:8090/admin/movies.php";
...
<body>
                      ...
                      <div class="card card-outline-primary card-rounded card-inverse-info grid-margin stretch-card">
                          ...
                          <div class="card-footer">
                              ...
                              <div class="text-right" id="$video[id]" >
                                ...
                                <button type="button" class="btn btn-danger btn-rounded btn-icon delete" name="$video[video_name]">
  ...
  <script src="js/movie/manager/movieManager.js"></script>
  <!-- endinject -->
