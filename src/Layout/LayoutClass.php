    ...
    const navBar = <<<HTML
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="navbar-brand-wrapper d-flex justify-content-center">
                ...
                <a class="navbar-brand brand-logo" href="/admin/home.php"><img src="/admin/images/logo.svg" alt="logo"/></a>
                <a class="navbar-brand brand-logo-mini" href="/admin/home.php"><img src="/admin/images/logo-mini.svg" alt="logo"/></a>
